...
//     { title: "Inspection User", url: "/franchise/inspections", icon: Package },
// ];
...
// ✅ Inspector Menu Items (Naya add kiya)
const inspectorMenuItems: MenuItem[] = [
  { title: "Dashboard", url: "/inspection/dashboard", icon: LayoutDashboard },
  { title: "Assigned Tasks", url: "/inspection/tasks", icon: ClipboardList },
  { title: "My Inspections", url: "/inspection/Completedinspections", icon: ClipboardCheck},
  // { title: "Profile", url: "/inspector/profile", icon: Settings },
...
const AppSidebar = ({ role }: SidebarProps) => {
  ...
  const menuItems = 
    role === "admin" ? adminMenuItems :
    role === "franchise" ? franchiseMenuItems :
     role === "inspection" ? inspectorMenuItems :
    dealerMenuItems;

  const roleLabel = 
    role === "admin" ? "Admin Panel" :
    role === "franchise" ? "Franchise Panel" :
    role === "inspection" ? "inspection Panel" :
